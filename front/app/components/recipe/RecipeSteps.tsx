...
const steps: Step[] = [
  {
    stepNumber: 1,
    stepImage: "/images/recipe-view/step1.png",
    stepDescription: "볼에 달걀을 풀은 후 소금을 넣어 섞어주세요.",
  },
  {
    stepNumber: 2,
    stepImage: "/images/recipe-view/step2.png",
    stepDescription:
      "순두부는 2cm 길이로 잘라주세요. 대파와 청양고추는 송송 썰어주세요.",
  },
  {
    stepNumber: 3,
    stepImage: "/images/recipe-view/step3.png",
    stepDescription:
      "끓으면 순두부 주변으로 달걀을 조금씩 붓고 살살 저어주세요.",
  },
  {
    stepNumber: 4,
    stepImage: "/images/recipe-view/step4.png",
    stepDescription:
      "냄비에 순두부를 가지런히 두고 멸치다시마물을 부어 끓으면 새우젓과 다진 마늘을 넣고 뚜껑을 닫아 끓여주세요. 끓으면서 생기는 거품은 걷어주세요.",
  },
  {
    stepNumber: 5,
    stepImage: "/images/recipe-view/step5.png",
    stepDescription:
