...
- 목표 : - 사용자에게 보다 편리한 사용성을 제공하기 위한 UX/UI를 제공합니다. - 모바일 사용자를 위한 반응형 페이지를 제공합니다. - 기존 레시피 공유 사이트의 노후화된 레시피 정보를 최신화 하고, 깔끔하게 재구성 합니다. - CSR과 SSR을 모두 사용한 최적화된 로딩 방식을 통해 사용자에게 더욱 빠른 인터렉션을 제공합니다.
  <br />
...
- 이수현
  - 레시피 조회 페이지, 레시피 스크랩 페이지
  - (재료 체크리스트, 목차바 & 스크롤 진행바, 팔로우 & 팔로우 취소, 프로필 카드, 댓글, 좋아요, 공유, 스크랩, 웹 및 모바일 반응형)
- 이나현
